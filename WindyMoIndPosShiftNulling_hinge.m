function myout = WindyMoIndPosShiftNulling_hinge(subj, stimType, vGabs, fname)
% WindyMoIndPosShiftNulling.m
% PSC - 11.25.2020 - Vertical test 

%% EXP - RUN!
 %WindyMoIndPosShiftNulling_hinge('zebPSC', 'zeb', 1, 'zebPSC.mat');
% WindyMoIndPosShiftNulling_hinge('cfxPSC', 'cfx', 1, 'cfxPSC.mat');

% WindyMoIndPosShiftNulling_hinge('zebLKC', 'zeb', 1, 'zebLKC.mat');
% WindyMoIndPosShiftNulling_hinge('cfxLKC', 'cfx', 1, 'cfxLKC.mat');
%%
...
nrepeat = 20;%20; % 20 repeat / condition 
...
%ept.stimRad = r_R; %300;  % radius of the circle of Gabors in pixels, 300 for experiment
...
pSF = (pSF) * VA_pix;
% Contrast of grating:
ept.contrast = 0.1; % 10% contrast% original = 10; 
