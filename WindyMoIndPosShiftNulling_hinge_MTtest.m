function myout = WindyMoIndPosShiftNulling_hinge_MTtest(subj, stimType, vGabs, fname)
% WindyMoIndPosShiftNulling.m
% PSC - 11.25.2020 - Vertical test 
% TO RUN TESTS: WindyMoIndPosShiftNulling_hinge_MTtest('hmt', 'zeb', 1, 'hmt.mat')
...
ept.ngabors = 8;    % 16 for experiment
